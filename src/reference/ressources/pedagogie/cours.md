...
```json [JSON]
{
  "@odata.context": "https://myapi.aimaira.net/GraphV1/$metadata#Cours/$entity",
  "Id": 1234567,
  "Nom": "TPDLC_1",
  "Code": "C00001234-1",
  "Actif": true,
...
```json [JSON]
{
  "@odata.context": "https://myapi.aimaira.net/GraphV1/$metadata#Cours(1234567)/EnseignantsCours",
  "value": [
    {
      "Id": 8836006,
      "Nom": "DUPONT Louis",
